...
import certicate5Img from '../assets/certicate5.png';
...
const Certificate = () => {
    const certificates = [
        ...
        },
        {
            ...
            type: "standard",
            recipient: "SWARAJ PRAJAPATI",
            description: "Verified certificate of achievement. Click below to view official PDF.",
            image: certicate5Img,
            verified: true,
            link: "/certificates/thumbnails/certificate5.pdf"
        },
        {
            title: "Certificate of Achievement",
            issuer: "",
            ...
            verified: true,
            link: "/certificates/thumbnails/Certificate6.pdf"
        },
        {
            title: "Certificate of Achievement",
            issuer: "",
            ...
            verified: true,
            link: "/certificates/thumbnails/certticiate7.pdf"
        }
    ];
        ...
        <section className="section-container" id="certificates">
            ...
            <div className="certificate-grid">
                {certificates.map((cert, index) => {
                    const isPremium = cert.type === 'premium';
                    return isPremium ? (
                        <motion.div
                            key={index}
                            ...
                            className="premium-certificate-card"
                            ...
                            <div className="certificate-inner">
                                <div className="cert-left-panel">
                                    ...
                                    <ul className="cert-benefits-list">
                                        {cert.benefits && cert.benefits.map((benefit, i) => (
                                            <li key={i}>{benefit}</li>
                                        ))}
                                    </ul>
                                    <div className="cert-footer">
                                        {cert.issuers && cert.issuers.map((issuer, i) => (
                        ...
                        <motion.div
                            ...
                            className="certificate-card-3d-wrapper"
                        >
                            <div className="certificate-card-3d">
                                {/* FRONT: Show the full certificate image */}
                                <div className="certificate-card-front">
                                    <div className="certificate-frame">
                                        <img 
                                            src={cert.image} 
                                            alt={cert.title} 
                                            className="certificate-img-full" 
                                            loading="lazy" 
                                        />
                                        <div className="certificate-glare" />
                                        <div className="certificate-front-badge">
                                            <span>{cert.title}</span>
                                        </div>
                                    </div>
                                </div>

                                {/* BACK: Show details, description, and link */}
                                <div className="certificate-card-back">
                                    <div className="certificate-back-content">
                                        <div className="certificate-issuer-logo">
                                            <div className="issuer-logo-dot" />
                                            <span>{cert.issuer || "Verified Credential"}</span>
                                        </div>
                                        
                                        <h3 className="certificate-title-back">{cert.title}</h3>
                                        
                                        {cert.date && (
                                            <span className="certificate-date-back">{cert.date}</span>
                                        )}
                                        
                                        <p className="certificate-desc-back">{cert.description}</p>
                                        ...
                                        {cert.link && cert.link !== "#" ? (
                                            <a
                                                ...
                                                className="certificate-btn-back"
                                            >
                                                <span>View Credentials</span>
                                                <ExternalLink size={16} />
                                            </a>
                                        ) : (
                                            <div className="certificate-btn-back-disabled">
                                                <span>Internally Verified</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
