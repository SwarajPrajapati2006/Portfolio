...
const About = () => {
    return (
        <section className="section-container" id="about">
            ...
            <div className="about-content glass-card premium-section-panel">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.6, delay: 0.2 }}
                >
                    <div className="about-eyebrow">Developer profile</div>
                    ...
                    <div className="about-signal-grid" aria-label="Developer strengths">
                        <span>Clean architecture</span>
                        <span>Frontend polish</span>
                        <span>Backend logic</span>
                        <span>Debugging depth</span>
                    </div>
                </motion.div>
            </div>
        </section>
